...
ACTIVE_DAY_CUTOFF_TOTAL_ALL = c(30, 60, 90)
...
for (ACTIVE_DAY_CUTOFF_TOTAL in ACTIVE_DAY_CUTOFF_TOTAL_ALL){ 
    for (STR_REGION in STR_REGION_ALL) {
        ...
        save(s1, s2, s3, s4, s5, s6, s7, ATTEMPT_CUTOFF, ACTIVE_DAY_CUTOFF_30D, ACTIVE_DAY_CUTOFF_TOTAL,
             file = sprintf("./sa_%s_total_active_%d_avg.RData", STR_REGION, ACTIVE_DAY_CUTOFF_TOTAL))
