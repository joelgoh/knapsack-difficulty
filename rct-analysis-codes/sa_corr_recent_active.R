...
# filter
ATTEMPT_CUTOFF = 4
ACTIVE_DAY_CUTOFF_30D_ALL = c(5, 10, 15)
...
for (ACTIVE_DAY_CUTOFF_30D in ACTIVE_DAY_CUTOFF_30D_ALL){ 
    for (STR_REGION in STR_REGION_ALL) {
        ...
        save(s1, s2, s3, s4, s5, s6, s7, ATTEMPT_CUTOFF, ACTIVE_DAY_CUTOFF_30D, ACTIVE_DAY_CUTOFF_TOTAL,
             file = sprintf("./sa_%s_recent_active_%d_avg.RData", STR_REGION, ACTIVE_DAY_CUTOFF_30D))
